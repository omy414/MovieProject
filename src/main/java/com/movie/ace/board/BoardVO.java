...
public class BoardVO {
	...
	public String toString() {
		return "BoardVO [mboard_no=" + mboard_no + ", member_id=" + member_id + ", member_name=" + member_name
				+ ", moviecd=" + moviecd + ", mboard_title=" + mboard_title + ", mboard_header=" + mboard_header
				+ ", mboard_reg_date=" + mboard_reg_date + ", mboard_hit_cnt=" + mboard_hit_cnt + ", mboard_content="
				+ mboard_content + ", mboard_like_cnt=" + mboard_like_cnt + ", mboard_dislike_cnt=" + mboard_dislike_cnt
				+ ", mboard_report_cnt=" + mboard_report_cnt + ", mboard_reply_cnt=" + mboard_reply_cnt + ", member_no="
				+ member_no + ", getMboard_no()=" + getMboard_no() + ", getMember_id()=" + getMember_id()
				...
				+ ", getMboard_reply_cnt()=" + getMboard_reply_cnt() + ", getMember_no()=" + getMember_no()
				+ ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString()
				+ "]";
	}
	public BoardVO(int mboard_no, String member_id, String member_name, int moviecd, String mboard_title,
			String mboard_header, Date mboard_reg_date, int mboard_hit_cnt, String mboard_content, int mboard_like_cnt,
			int mboard_dislike_cnt, int mboard_report_cnt, int mboard_reply_cnt, int member_no) {
		super();
		this.mboard_no = mboard_no;
		this.member_id = member_id;
		this.member_name = member_name;
