            ...
            <form:form role="form" name="registerForm" modelAttribute="registerRequest" action="${pageContext.request.contextPath }/signUp" 
                ...
                <div class="form-group has-feedback">
                    <form:input type="text" class="form-control" placeholder="아이디는 4~12자의 영문 대소문자와 숫자로만 입력" 
                    	path="id" style="float:left" value="${userInfo.member_id}"/>
                ...
                <br/>
                <form:checkboxes items="${genreList}" path="genres"/>
               ...
               <button class="check" onclick="check();" value="엄청 큰 버튼">asdsad</button>
         
<script>

	function check(){
		alert("${userInfo.member_no}");
	}
