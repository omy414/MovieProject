		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo"> <img src="resources/img/logo.png" alt="IMG-LOGO">
					</a>
					...
					<div class="wrap-icon-header flex-w flex-r-m h-full"> <!--  검색 아이콘 -->
						...
						<div class="flex-c-m h-full p-lr-19"> <!-- 메뉴바 아이콘 -->
		...
		<div class="sidebar flex-col-l p-t-22 p-b-25">
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				<ul class="sidebar-link w-full">
					...
					<li class="p-b-13"><a href="#" class="stext-102 cl2 hov-cl1 trans-04"> My Account </a></li>

					<li class="p-b-13"><a href="#" class="stext-102 cl2 hov-cl1 trans-04"> Track Oder </a></li>

					<li class="p-b-13"><a href="#" class="stext-102 cl2 hov-cl1 trans-04"> Refunds </a></li>

					<li class="p-b-13"><a href="#" class="stext-102 cl2 hov-cl1 trans-04"> Help & FAQs </a></li>
				</ul>
				...
				<div class="sidebar-gallery w-full">
					...
					<p class="stext-108 cl6 p-t-27">Captain 이아르미, <br> Boss &nbsp;&nbsp;&nbsp;&nbsp; 오민영,<br> Assistant 염승훈, <br>President 박경남</p>
				</div>
			</div>
		</div>
	</aside>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<!--===============================================================================================-->
	<script src="resources/vendor/animsition/js/animsition.min.js"></script> <!-- 상단 메뉴 애니메이션 관련 중요! -->
	<!--===============================================================================================-->
